package com.lalas.musicgpt.data.ui.theme
...
// Extension for custom font weights
object InterTypography {
    fun headlineBold(fontSize: Int) = TextStyle(
        fontFamily = InterFontFamily,
        fontWeight = FontWeight.Bold,
    ...
    fun bodyMedium(fontSize: Int) = TextStyle(
        fontFamily = InterFontFamily,
        fontWeight = FontWeight.Medium,
        fontSize = fontSize.sp,
        letterSpacing = 0.15.sp,
    ...
    fun labelSemiBold(fontSize: Int) = TextStyle(
        fontFamily = InterFontFamily,
        fontWeight = FontWeight.SemiBold,
        fontSize = fontSize.sp,
        letterSpacing = 0.1.sp,
